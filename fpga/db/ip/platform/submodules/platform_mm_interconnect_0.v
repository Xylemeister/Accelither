...
module platform_mm_interconnect_0 (
	...
	wire  [94:0] memory_s1_agent_rf_source_data;                                            // memory_s1_agent:rf_source_data -> memory_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] memory_s1_agent_rsp_fifo_out_data;                                         // memory_s1_agent_rsp_fifo:out_data -> memory_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> memory_s1_agent:cp_data
	...
	wire  [94:0] filter_x_s1_agent_rf_source_data;                                          // filter_x_s1_agent:rf_source_data -> filter_x_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] filter_x_s1_agent_rsp_fifo_out_data;                                       // filter_x_s1_agent_rsp_fifo:out_data -> filter_x_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> filter_x_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // filter_x_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> filter_x_s1_agent:cp_channel
	...
	wire  [94:0] filter_y_s1_agent_rf_source_data;                                          // filter_y_s1_agent:rf_source_data -> filter_y_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] filter_y_s1_agent_rsp_fifo_out_data;                                       // filter_y_s1_agent_rsp_fifo:out_data -> filter_y_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> filter_y_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // filter_y_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> filter_y_s1_agent:cp_channel
	...
	wire  [94:0] filter_z_s1_agent_rf_source_data;                                          // filter_z_s1_agent:rf_source_data -> filter_z_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] filter_z_s1_agent_rsp_fifo_out_data;                                       // filter_z_s1_agent_rsp_fifo:out_data -> filter_z_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> filter_z_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // filter_z_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> filter_z_s1_agent:cp_channel
	...
	wire  [93:0] memory_s1_agent_rp_data;                                                   // memory_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [93:0] filter_x_s1_agent_rp_data;                                                 // filter_x_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [93:0] filter_y_s1_agent_rp_data;                                                 // filter_y_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [93:0] filter_z_s1_agent_rp_data;                                                 // filter_z_s1_agent:rp_data -> router_007:sink_data
